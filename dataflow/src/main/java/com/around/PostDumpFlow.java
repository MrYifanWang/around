...
public class PostDumpFlow {
  ...
  private static final String PROJECT_ID = "around-225723";
  private static final String BTINSTANCE_ID = "around-post";
  private static final String BUCKET_ID = "around-225723";
  ...
  public static void main(String[] args) {
    ...
    CloudBigtableScanConfiguration config = new CloudBigtableScanConfiguration.Builder().withProjectId(PROJECT_ID)
        .withInstanceId(BTINSTANCE_ID).withTableId(BUCKET_ID).build();
